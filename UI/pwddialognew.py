...
class Ui_passworddialog(object):
    def setupUi(self, passworddialog):
        ...
        passworddialog.setMaximumSize(QtCore.QSize(400, 350))
        ...
        self.confirm = QtWidgets.QLabel(passworddialog)
        font = QtGui.QFont()
        font.setBold(True)
        self.confirm.setFont(font)
        self.confirm.setObjectName("confirm")
        self.inputform.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.confirm)
        self.pwdfieldconfirm = QtWidgets.QLineEdit(passworddialog)
        self.pwdfieldconfirm.setMinimumSize(QtCore.QSize(0, 30))
        self.pwdfieldconfirm.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.pwdfieldconfirm.setObjectName("pwdfieldconfirm")
        self.inputform.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.pwdfieldconfirm)
...
"}")
    ...
    def retranslateUi(self, passworddialog):
        ...
        self.confirm.setText(_translate("passworddialog", "Confirm:"))
